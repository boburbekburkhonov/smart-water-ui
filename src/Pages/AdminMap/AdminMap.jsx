...
const AdminMap = () => {
  ...
  const getWarningStation = item => {
    if(item?.todayData?.length > 0){
     if(item?.todayData[0]?.volume == -1 && item?.todayData[0]?.level == -1) {
       return {
         id: 0,
         name: item?.name,
         volume: -1,
     ...
     }else if (item?.todayData[0]?.volume == -1 && item?.todayData[0]?.level != -1) {
       return {
         id: 1,
         volume: -1,
         name: item?.name,
   ...
   }else if(item?.yesterdayData?.length > 0) {
      if(item?.yesterdayData[0]?.volume == -1 && item?.yesterdayData[0]?.level == -1) {
        return {
          id: 0,
          name: item?.name,
          volume: -1,
      ...
      }else if (item?.yesterdayData[0]?.volume == -1 && item?.yesterdayData[0]?.level != -1) {
        return {
          id: 1,
          volume: -1,
          name: item?.name,
   ...
   } else if(item?.dailyData?.length > 0) {
      if(item?.dailyData[0]?.volume == -1 && item?.dailyData[0]?.level == -1) {
        return {
          id: 0,
          name: item?.name,
          volume: -1,
      ...
      }else if (item?.dailyData[0]?.volume == -1 && item?.dailyData[0]?.level != -1) {
        return {
          id: 1,
          volume: -1,
          name: item?.name,
    ...
    } else if(item?.monthlyData?.length > 0) {
        if(item?.monthlyData[0]?.volume == -1 && item?.monthlyData[0]?.level == -1) {
          return {
            id: 0,
            name: item?.name,
            volume: -1,
        ...
        }else if (item?.monthlyData[0]?.volume == -1 && item?.monthlyData[0]?.level != -1) {
          return {
            id: 1,
            volume: -1,
            name: item?.name,
    ...
    } else if(item?.lastData?.length > 0) {
        if(item?.lastData[0]?.volume == -1 && item?.lastData[0]?.level == -1) {
          return {
            id: 0,
            name: item?.name,
            volume: -1,
        ...
        }else if (item?.lastData[0]?.volume == -1 && item?.lastData[0]?.level != -1) {
          return {
            id: 1,
            volume: -1,
            name: item?.name,
                                    ...
                                    <div>
                                      ...
                                      <div className="d-flex align-items-center mb-1">
                                        ...
                                        <span className="infowindow-span">
                                          {Number(e.lastData[0]?.level).toFixed(2)} sm
                                        </span>
                                      </div>
                                      ...
                                      <div className="d-flex align-items-center mb-1">
                                        ...
                                        <span className="infowindow-span">
                                          {Number(e.lastData[0]?.correction).toFixed(2)}{" "}
                                        </span>
                                      </div>
                                      ...
                                      <div className="d-flex align-items-center">
                                        ...
                                        <span className="infowindow-span">
                                          {e.lastData[0].date?.split("-")[0]}/
                                          {e.lastData[0].date?.split("-")[1]}/
                                          {e.lastData[0].date
                                            ?.split("-")[2]
                                            .slice(0, 2)}{" "}
                                          {
                            ...
                            {e.lastData.length != 0 ? (
                              <div>
                                ...
                                <div className="d-flex align-items-center mb-1">
                                  ...
                                  <span className="infowindow-span">
                                    {Number(e.lastData[0]?.volume).toFixed(2)} m³/s
                                  </span>
                                </div>
                                ...
                                <div className="d-flex align-items-center">
                                  ...
                                  <span className="infowindow-span">
                                    {e.lastData[0]?.date?.split("-")[0]}/
                                    {e.lastData[0]?.date?.split("-")[1]}/
                                    {e.lastData[0]?.date?.split("-")[2].slice(0, 2)}{" "}
                                    {
                                      e.lastData[0]?.date
                                        .split("T")[1]
                                        .split(":")[0]
